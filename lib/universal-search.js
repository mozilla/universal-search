...
Search.prototype = {
  ...
  _loadStyleSheets: function(win) {
    ...
    //Check whether platform type is 'Darwin', 'Linux', or 'WINNT'.
    ...
    // If OS is Mac, load style-osx.css.
    if (osString == 'Darwin') {
      stylesheet.href = 'chrome://universalsearch-skin/content/style-osx.css';
    //If OS is Linux, load style-linux.css.
    } else if (osString == 'Linux') {
      stylesheet.href = 'chrome://universalsearch-skin/content/style-linux.css';
    //Otherwise, load style-windows.css.
    } else {
      stylesheet.href = 'chrome://universalsearch-skin/content/style-windows.css';
    }
  ...
  _unloadScripts: function(win) {
    ...
    Cu.unload('resource://gre/modules/Services.jsm', win.universalSearch);
  },
