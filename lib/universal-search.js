...
XPCOMUtils.defineLazyModuleGetter(this, 'registerVariants',
  'chrome://universalsearch-lib/content/variants.js');
...
Search.prototype = {
  addonId: 'universal-search@mozilla.com',
  ...
  loadIntoWindow: function(win) {
    ...
    win.universalSearch.variants = {};

    registerVariants(this.addonId, this.variantTests).then(payload => {
      win.universalSearch.variants = JSON.parse(payload.data);
    });
