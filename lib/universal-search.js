...
Search.prototype = {
  ...
  _loadScripts: function(win) {
    ...
    Cu.import('chrome://universalsearch-ui/content/results.js', win.universalSearch);
  ...
  _unloadScripts: function(win) {
    ...
    Cu.unload('chrome://universalsearch-ui/content/results.js', win.universalSearch);
  ...
  _startApp: function(win) {
    ...
    app.recommendationServer = new app.RecommendationServer({
      ...
      resultClasses: app.resultClasses
    });
